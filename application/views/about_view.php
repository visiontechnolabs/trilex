    ...
    <div class="container py-5">
        ...
        <div class="about-content">
            ...
            <div class="about-section story-section">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">100+ Clients Milestone</div>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-year">2024</div>
                        <div class="timeline-content">Industry Recognition</div>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-year">2025</div>
                        <div class="timeline-content">Global Expansion</div>
                    </div>
                </div>
            </div>

            <!-- Mission Section -->
            <div class="about-section mission-section highlight">
            ...
            <div class="about-section values-section">
                ...
                <div class="values-grid">
                    ...
                    <div class="value-card">
                        ...
                        <p>Your success is our priority. We build lasting partnerships based on trust.</p>
                    </div>
                    ...
                    <div class="value-card">
                        ...
                        <h3>Reliability</h3>
                        <p>Consistent delivery and dependable service you can count on, every time.</p>
                    </div>
                    ...
                    <div class="value-card">
                        ...
                        <h3>Agility</h3>
                        <p>We adapt quickly to changing needs and market dynamics with flexibility.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="cta-section">
                ...
                <p>Let's discuss how we can help drive your business forward</p>
                <div class="cta-buttons">
                    <a href="<?= base_url('contact') ?>" class="btn btn-primary">Get in Touch</a>
                    <a href="<?= base_url('blog') ?>" class="btn btn-outline">Explore Blog</a>
                </div>
            </div>
...
<style>
    * {
    ...
    :root {
        ...
        --shadow-md: 0 4px 16px rgba(28, 118, 143, 0.08);
        --shadow-lg: 0 12px 32px rgba(28, 118, 143, 0.12);
        --shadow-xl: 0 20px 48px rgba(28, 118, 143, 0.15);
    }
    ...
    .about-section.highlight {
        ...
        padding: 3rem;
        border-radius: 24px;
        border: 1px solid rgba(28, 118, 143, 0.1);
        position: relative;
        overflow: hidden;
    }

    .about-section.highlight::before {
        content: '';
        position: absolute;
        top: -50%;
        right: -10%;
        width: 300px;
        height: 300px;
        background: radial-gradient(circle, rgba(28, 118, 143, 0.08) 0%, transparent 70%);
        pointer-events: none;
    }
