...
<style>
    * {
    ...
    .contact-card.featured {
        background: linear-gradient(135deg, var(--primary-light) 0%, rgba(230, 244, 247, 0.5) 100%);
    ...
    .alternate-icon.linkedin {
        background: #0077b5;
        color: white;
    }

    .alternate-icon.twitter {
        background: #1da1f2;
        color: white;
    }

    .alternate-icon.whatsapp {
        background: #25d366;
        color: white;
    }

    .alternate-icon.schedule {
        background: var(--primary-light);
        color: var(--primary-color);
    }
